...
import (
	...
	zapadapter "github.com/linuxboot/contest/pkg/xcontext/logger/logadapter/zap"
...
func NewContext(logLevel logger.Level, opts ...bundles.Option) xcontext.Context {
	...
	ctx := xcontext.NewContext(
		stdCtx, "",
		loggerInstance, prometheusadapter.New(prometheusRegistry, prometheusRegistry), cfg.Tracer,
		nil, nil)
	return ctx
}
